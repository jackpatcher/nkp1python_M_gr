...
--------------------------------------------------------------------------
           ...
           1. สั่ง Ftest() ก่อนเพื่อหาระยะ 1 แผ่น  แก้ไขที่ตัวแปร gV gT
...
def test():
    print("test")      #เปิดทีละคำสั่ง เพื่อทดสอบ  ctrl+/
    Ftest()	 #หา 1 แผ่น หากไม่ตรง แก้ไขที่ตัวแปร gT gV
...
def Ftest():
    print("F ทดสอบ 1 แผ่น ...")
    global gV,gT
    am.start_move(gV, gV);am.wait(gT) 
    am.stop()     
